		...
		<li >
            ...
            <div id="nr">
               <li>
                ...
                <li >
                    ...
                    <ul class="sub-menu">
                        <li><a _href="/collectlist"><i class="iconfont">&#xe6a7;</i><cite>查看个性化方案</cite></a></li>
                    </ul>
                </li>
                 <li >
                    <a href="javascript:;" id="qhnr">
            ...
            @elseif($role==3)
                ...
                <li >
                    ...
                    <ul class="sub-menu">
                        <li><a _href="/collectlist"><i class="iconfont">&#xe6a7;</i><cite>教师备课的课节</cite></a></li>
                    </ul>
                </li>
                 <li >
                    <a _href="/pptlist">
            ...
            @elseif($role==4)
               <li>
                ...
                <li >
                    ...
                    <ul class="sub-menu">
                        <li><a _href="/"><i class="iconfont">&#xe6a7;</i><cite>查看个性化方案</cite></a></li>
                    </ul>
                </li>
            @elseif($role==5)
                <li>
