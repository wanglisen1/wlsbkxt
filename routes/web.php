...
//
Route::any('/dysession','Admin\AdminController@dysession');
//后台首页窗口
...
////pdf展示
//Route::any('/pdflist','Admin\AdminController@pdflist');

//删除ppt
Route::any('/delpptkj','Admin\AdminController@delpptkj');

//生成随机码
//Route::any('/bwshowlist','Admin\AdminController@BwshowList');
//随机码登陆处理
Route::any('/bwlogincl','Admin\AdminController@BwLoginCl');
//登陆页面
Route::any('/bwlogin','Admin\AdminController@BwLogin');
//展示页面
Route::any('/million','Admin\AdminController@Million');
//验证登陆
Route::any('/yzmilllog','Admin\AdminController@YzMillLog');
//验证过期
Route::any('/yzpass','Admin\AdminController@YzPass');
//激活码列表
Route::any('/millionlist','Admin\AdminController@MillionList');
//查看激活时间
Route::any('/millionlistxq','Admin\AdminController@MillionListXq');

//筛选校区
Route::any('/screensch','Admin\AdminController@ScreenSch');
